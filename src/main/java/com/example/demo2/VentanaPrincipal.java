...
//    public static conexion con;
    ...
    public VentanaPrincipal(){
        ...
        for(int iterator =0 ;iterator<12;iterator++){
            ...
            switch(iterator){
                case 0:
                    ...
                    bton.setOnAction(event->{this.close();new vista_clientes();});
                    break;
                    case 1:
                        alterm="/imagenes/categorias.png";
                        bton.setOnAction(event->{this.close();new vista_categorias();});
                        break;
                        case 2:
                            alterm="/imagenes/empleados.png";
                            bton.setOnAction(event->{this.close();new vista_empleados();});
                            break;
                            case 3:
                                alterm="/imagenes/insumos.png";
                                bton.setOnAction(event->{this.close();new vista_insumos();});
                                break;
                                case 4:
                                    alterm="/imagenes/juego-de-mesa.png";
                                    bton.setOnAction(event->{this.close();new vista_mesas();});
                                    break;
                                    case 5:
                                        alterm="/imagenes/ordenes.png";
                                        bton.setOnAction(event->{this.close();new vista_ordenes();});
                                        break;
                                        case 6:
                                            alterm="/imagenes/productos.png";
                                            bton.setOnAction(event->{this.close();new vista_productos();});
                                            break;
                                            case 7:
                                                alterm="/imagenes/proveedor.png";
                                                bton.setOnAction(event->{this.close();new vista_proveedores();});
                                                break;
                                                case 8:
                                                    alterm="/imagenes/reservacion.png";
                                                    bton.setOnAction(event->{this.close();new vista_reservaciones();});
                                                    break;
                                                    case 9:
                                                        alterm="/imagenes/detalleorden.png";
                                                        bton.setOnAction(event->{this.close();new vista_detorden();});
                                                        break;
                                                        case 10:
                                                            alterm="/imagenes/detalleproducto.png";
                                                            bton.setOnAction(event->{this.close();new vista_detproducto();});
                                                            break;
                                                            case 11:
                                                                alterm="/imagenes/reservacionmesa.png";
                                                                bton.setOnAction(event->{this.close();new vista_reservacionmesa();});
                                                                break;
        ...
        contenedor_uno = new HBox(new Label("  Orden-->  "),total,cntidad_productos,mesa_field,boton_refresh,boton_outro,boton_iniciar_ventana_elementos);
