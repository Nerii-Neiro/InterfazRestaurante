  ...
  private double total;
    ...
    public Orden orden_crear(){
        ...
        try{
            ...
            while(result.next()){
                return new Orden(result.getInt("id_orden"),result.getString("fecha"),result.getString("hora"),result.getString("descripcion"),result.getString("notas"),result.getInt("id_cliente"),result.getInt("id_mesa"),result.getInt("id_empleado"),result.getDouble("total"));
            }
        }
        catch(Exception e){}
